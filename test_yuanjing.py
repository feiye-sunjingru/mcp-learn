...
API_KEY = os.getenv("YUANJING_API_KEY")

if not API_KEY:
    raise ValueError("请在 .env 文件中设置 YUANJING_API_KEY")

def call_yuanjing(messages, model="yuanjing-70b-chat"):
    """
    调用联通元景大模型 API
